...
; The processor is in 16-bit real mode (default mode when computer is powered on).
...
; The video memory starts at 0x0b8000. To access this address, a segment register must be used.
; ====================================================================================================
