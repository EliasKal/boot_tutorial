; ====================================================================================================
; This is a simple bootloader. It loads some sectors from floppy to memory, and executes them.
; Loading from memory is done with BIOS interrupt 0x13, with ah = 0x02.
; Before calling the interrupt, appropriate values must be put in specific registers.
...
start:
   ...
   mov al, 0x05		; num of sectors to read, here read 5 sectors (more than enough)
