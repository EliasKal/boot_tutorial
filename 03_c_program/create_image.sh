...
# First the bootloader is compiled and a bootable file (bootloader.bin.padded)
# is created.
...
# sets the code's starting address at 0x8000 (as expected by bootloader, see 
# bootloader.asm)
...
# Finally bootloader.bin.padded and kernel.bin.padded are concatenated to form 
# the image file.
# ==============================================================================
...
nasm -f elf -o start.o start.asm		# output format is elf, so it can be 
                                        # linked with main
