...
; Here it sets up a simple stack by initializing the stack pointer. Then main 
; is called.
; In this program there is no [ORG] directive.
; The code's starting address (0x8000, as defined in bootloader.asm) is given 
; as a parameter to the linker, when start and main are linked together 
; (see create_image.sh).
; ==============================================================================
